//This program moves every element in a character
//list to the right and replaces the first letter.
//z5309196 
//This program was written by Christopher Luong 26/04/2020
...
void pad_left(struct character_node *characters, char pad_character) {
    ...
    if (characters != NULL) {
        temp_prev = characters->data;
        characters->data = pad_character;
        characters = characters->next;    
        while (characters != NULL) {
            temp_after = characters->data;
            characters->data = temp_prev;
            temp_prev = temp_after;
